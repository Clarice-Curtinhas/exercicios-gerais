...
void ExecutaBotao(Botao b){
    if(b.tipo == CLICK || b.tipo == LONGO_CLICK || b.tipo == HOVER){
        if(b.tipo == CLICK) printf("- Executando o botao com evento de click\n");
        else if(b.tipo == LONGO_CLICK) printf("- Executando o botao com evento de longo click\n");
        else printf("- Executando o botao com evento de hover\n");
